...
public class ScrumTeam {
    ...
    public ScrumTeam(String PO, String BA, String SM, ArrayList<Tester> testersList, ArrayList<Developer> devopsList, int daysOfSprint) {
        setPO(PO);
        setBA(BA);
        setSM(SM);
        testersList = new ArrayList<>(); // ArrayList' Object has to be created to use the ArrayList
        devopsList = new ArrayList<>(); // ArrayList' Object has to be created to use the ArrayList
