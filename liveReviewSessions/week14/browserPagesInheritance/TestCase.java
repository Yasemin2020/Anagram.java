...
// Can I use amazonHomePage object to reach ProductPage shopFor method
        ...
        // productObject.navigateTo("Card");  we can use as well child class object
        amazonHomePage.navigateTo("Card");

        CardPage cardPage = new CardPage("Chrome", "Mike Smith");
        cardPage.fillInfo();
        cardPage.payFor(4325654634251678L);

        cardPage.setName("Firefox");  // There is already an open browser : Chrome

        cardPage.closeBrowser();

        cardPage.setName("Firefox");
        System.out.println("I am automating : "+cardPage.getName());
