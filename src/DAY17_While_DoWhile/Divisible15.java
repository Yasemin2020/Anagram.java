...
public class Divisible15 {
    public static void main(String[] args) {
        ...
        int n=scan.nextInt();
        String divisible15="",divisible5="",divisible3="";
        ...
        System.out.println("Dividible by 15: " + divisible15);

        System.out.println("Dividible by 5: " + divisible5);

        System.out.println("Dividible by 3: " + divisible3);
/*
