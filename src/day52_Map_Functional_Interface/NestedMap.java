...
public class NestedMap {
    public static void main(String[] args) {
        ...
        System.out.println("Veronica"+" = " + mapOfMap.get(map1).get("Veronica"));

        System.out.println("------------------------------------------");
        Map<Map<Map<Integer,Integer>, Map<Integer,Integer>>, Map<Map<Integer,Integer>, Map<Integer,Integer>>> mapOfMapOafMap=new LinkedHashMap<>();
