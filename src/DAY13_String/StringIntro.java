...
public class StringIntro {
    public static void main(String[] args) {
        ...
        String name4 = "Wooden Spoon";// There is only one "wooden spoon" in the heap stored
        //"wooden spoon" bir object ve bunu kullanan 4 isim var

        System.out.println(name==name2);//true
        System.out.println(name2==name3);//true
        System.out.println(name3==name4);//true
        //hepsi aynı object ile saklanır. String pool da saklanır
