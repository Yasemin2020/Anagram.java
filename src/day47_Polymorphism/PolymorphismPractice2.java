...
public class PolymorphismPractice2 {
    public static void main(String[] args) {
        ...
        Developer devWithMaxSalary= developers.get(0);
        ...
        for (Developer each : developers) {
            if (each.getSalary()>devWithMaxSalary.getSalary()){
                devWithMaxSalary=each;
            }
        }
        System.out.println("devWithMaxSalary = " + devWithMaxSalary);
